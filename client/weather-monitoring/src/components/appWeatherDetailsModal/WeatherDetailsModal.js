...
const WeatherDetailsModal = ({ city, onClose, weatherService }) => {
    ...
    const chartData = {
        ...
        datasets: [
            {
                label: 'Temperature (°C)',
                data: filteredChanges.map(change => change.temperatureCelsius),
            ...
            {
                label: 'Humidity (%)',
                data: filteredChanges.map(change => change.humidity),
            ...
            },
            {
                ...
                data: filteredChanges.map(change => change.pressureIn),
            ...
            },
            {
                ...
                data: filteredChanges.map(change => change.windSpeedKph),
